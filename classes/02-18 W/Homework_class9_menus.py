        ...
        while True:
            ...
            if choice is None:
                ...
                while True:
                    ...
                    elif choice == 1:  # View Client Summary (LEAF)
                        fn2.clear_screen()
                    ...
                    elif choice == 2:  # Manage Client Cash (LEAF)
                        fn2.clear_screen()
                ...
                while True:
                    ...
                    elif choice == 1:  # New Individual (LEAF)
                        fn2.clear_screen()
        ...
        while True:
            ...
            if choice is None:
                ...
                while True:
                    ...
                    elif choice == 1:  # Holdings Snapshot (LEAF)
                        fn2.clear_screen()
